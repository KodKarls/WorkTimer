all:
	g++ Main.cpp header\Logger.hpp header\Utilities.hpp header\SplashScreen.hpp header\EachScreen.hpp header\screens.hpp source\Logger.cpp source\Utilities.cpp source\SplashScreen.cpp -o WorkTimer.exe \
